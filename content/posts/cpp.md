...
這個標頭檔包含了之後會使用到的任何輸入輸出、資料結構，還藏有很多很方便的函式像是 `<algorithm>` 裡的\_\_gcd(計算最大公因數)
...
舉例：  
$ 10*{10}\ |\ 8*{10} = 1010*2\ |\ 1000_2 = 1010_2 = 10*{10} $$
...
$ 10*{10} \oplus 8*{10} = 1010*2 \oplus 1000_2 = 0010_2 = 2*{10} $
